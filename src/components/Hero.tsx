...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-[100svh] flex items-center pt-16 sm:pt-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-secondary/95 via-secondary/85 to-secondary/30 sm:to-transparent"></div>
      </div>

      {/* Content */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-full sm:max-w-xl lg:max-w-2xl animate-fade-in">
          ...
          <h2 className="text-lg sm:text-xl md:text-2xl text-primary-foreground/90 mb-6 sm:mb-8 leading-relaxed">
            Excelência que você confia, segurança que você merece
          </h2>
          <p className="text-base sm:text-lg text-primary-foreground/80 mb-8 sm:mb-10 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <Button 
              ...
              className="bg-primary-foreground/10 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/20 hover:border-primary-foreground/50 backdrop-blur-sm w-full sm:w-auto"
            >
